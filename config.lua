...
EssentialsConfig = {
    ...
    --- This will prevent police, EMS, and other unwanted AI from spawning.
    disableEmergencyServicesAI = true,

    --- Configures the density of the AI for all clients in this server
    --- locals      - controls the density of the AI population (0.0 - 10.0)
    --- vehicles    - controls the density of AI vehicles       (0.0 - 10.0)
    aiDensity = {
        --- The density of the AI population    (0.0 - 10.0)
        locals = 1.0,
        --- The density of the AI vehicles      (0.0 - 10.0)
        vehicles = 1.0,
    },
